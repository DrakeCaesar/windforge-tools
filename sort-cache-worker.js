 ...
 * Loaded only as a worker script (importScripts relative to this file).
 */
importScripts("recipe-sort.js", "sort-permutation-core.js");

const SP = self.itemCatalogSortPermutation;
...
function initWorkerPayload(payload) {
  ...
  workerState.recipeSortEngine = self.createRecipeSortEngine();
